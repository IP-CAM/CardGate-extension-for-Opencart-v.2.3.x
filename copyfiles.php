...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/controller/extension/payment/cardgatemistercash.php';
$dst = 'cardgate/admin/controller/extension/payment/cardgatemistercash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/language/en-gb/extension/payment/cardgatemistercash.php';
$dst = 'cardgate/admin/language/en-gb/extension/payment/cardgatemistercash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/language/nl-nl/extension/payment/cardgatemistercash.php';
$dst = 'cardgate/admin/language/nl-nl/extension/payment/cardgatemistercash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgatemistercash.tpl';
$dst = 'cardgate/admin/view/template/extension/payment/cardgatemistercash.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/controller/extension/payment/cardgatemistercash.php';
$dst = 'cardgate/catalog/controller/extension/payment/cardgatemistercash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/language/en-gb/extension/payment/cardgatemistercash.php';
$dst = 'cardgate/catalog/language/en-gb/extension/payment/cardgatemistercash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/language/nl-nl/extension/payment/cardgatemistercash.php';
$dst = 'cardgate/catalog/language/nl-nl/extension/payment/cardgatemistercash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/model/extension/payment/cardgatemistercash.php';
$dst = 'cardgate/catalog/model/extension/payment/cardgatemistercash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgatemistercash.tpl';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgatemistercash.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
