...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/controller/extension/payment/cardgategiftcard.php';
$dst = 'cardgate/admin/controller/extension/payment/cardgategiftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/controller/extension/payment/cardgatepaysafecash.php';
$dst = 'cardgate/admin/controller/extension/payment/cardgatepaysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/language/en-gb/extension/payment/cardgategiftcard.php';
$dst = 'cardgate/admin/language/en-gb/extension/payment/cardgategiftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/language/en-gb/extension/payment/cardgatepaysafecash.php';
$dst = 'cardgate/admin/language/en-gb/extension/payment/cardgatepaysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/language/nl-nl/extension/payment/cardgategiftcard.php';
$dst = 'cardgate/admin/language/nl-nl/extension/payment/cardgategiftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/language/nl-nl/extension/payment/cardgatepaysafecash.php';
$dst = 'cardgate/admin/language/nl-nl/extension/payment/cardgatepaysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgatebillink.tpl';
$dst = 'cardgate/admin/view/template/extension/payment/cardgatebillink.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgategiftcard.tpl';
$dst = 'cardgate/admin/view/template/extension/payment/cardgategiftcard.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgateidealqr.tpl';
$dst = 'cardgate/admin/view/template/extension/payment/cardgateidealqr.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgatepaysafecard.tpl';
$dst = 'cardgate/admin/view/template/extension/payment/cardgatepaysafecard.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgatepaysafecash.tpl';
$dst = 'cardgate/admin/view/template/extension/payment/cardgatepaysafecash.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/controller/extension/payment/cardgategiftcard.php';
$dst = 'cardgate/catalog/controller/extension/payment/cardgategiftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/controller/extension/payment/cardgatepaysafecash.php';
$dst = 'cardgate/catalog/controller/extension/payment/cardgatepaysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/language/en-gb/extension/payment/cardgategiftcard.php';
$dst = 'cardgate/catalog/language/en-gb/extension/payment/cardgategiftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/language/en-gb/extension/payment/cardgatepaysafecash.php';
$dst = 'cardgate/catalog/language/en-gb/extension/payment/cardgatepaysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/language/nl-nl/extension/payment/cardgategiftcard.php';
$dst = 'cardgate/catalog/language/nl-nl/extension/payment/cardgategiftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/language/nl-nl/extension/payment/cardgatepaysafecash.php';
$dst = 'cardgate/catalog/language/nl-nl/extension/payment/cardgatepaysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/model/extension/payment/cardgategiftcard.php';
$dst = 'cardgate/catalog/model/extension/payment/cardgategiftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/model/extension/payment/cardgatepaysafecash.php';
$dst = 'cardgate/catalog/model/extension/payment/cardgatepaysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgatebillink.tpl';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgatebillink.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgategiftcard.tpl';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgategiftcard.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgateidealqr.tpl';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgateidealqr.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgatepaysafecard.tpl';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgatepaysafecard.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgatepaysafecash.tpl';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgatepaysafecash.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
