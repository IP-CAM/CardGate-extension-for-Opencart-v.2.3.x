<form class="form-horizontal">
  <img style="max-height: 30px;max-width: 70px;" src="./image/payment/cgp/onlineueberweisen.svg" alt="OnlineÜberweisen">
 </form>
  <div class="buttons">
...
$('#button-confirm').bind('click', function() {
	$.ajax({
		 url: 'index.php?route=extension/payment/cardgateonlineueberweisen/confirm',
		type: 'get',
		dataType: 'json',
		beforeSend: function() {
