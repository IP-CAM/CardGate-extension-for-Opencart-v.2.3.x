...
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate OnlineÜberweisen" title="Cardgate OnlineÜberweisen" style="border: 1px solid #EEEEEE;" /></a>';
