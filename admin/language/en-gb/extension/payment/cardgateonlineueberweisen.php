...
$_['text_cardgateonlineueberweisen']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate OnlineÜberweisen" title="Cardgate OnlineÜberweisen" style="border: 1px solid #EEEEEE;" /></a>';
