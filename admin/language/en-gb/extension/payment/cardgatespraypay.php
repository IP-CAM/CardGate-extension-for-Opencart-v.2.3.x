...
$_['text_cardgatespraypay']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate SprayPay" title="Cardgate SprayPay" style="border: 1px solid #EEEEEE;" /></a>';
