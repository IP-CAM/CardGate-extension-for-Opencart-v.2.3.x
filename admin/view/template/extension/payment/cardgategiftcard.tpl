    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-cardgategiftcard" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cardgategiftcard" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgategiftcard_total" value="<?php echo $cardgategiftcard_total; ?>" id="entry-total" class="form-control"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgategiftcard_geo_zone_id" id="entry-geo-zone-id" class="form-control">
                                        <option value="0"><?php echo $text_all_zones; ?></option>
                                        <?php foreach ($geo_zones as $geo_zone) { ?>
                                        <?php if ($geo_zone['geo_zone_id'] == $cardgategiftcard_geo_zone_id) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgategiftcard_status" id="entry-plugin-status" class="form-control">
                                        <?php if ($cardgategiftcard_status): ?>
                        ...
                        <div class="tab-pane" id="tab-status">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgategiftcard_sort_order" value="<?php echo $cardgategiftcard_sort_order; ?>" id="entry-sort-order" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane " id="tab-info">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgategiftcard-plugin-version" value="<?php echo $entry_plugin_version;?>" class="form-control" /> 
                                </div>
                            </div>
                            <div class="form-group">
