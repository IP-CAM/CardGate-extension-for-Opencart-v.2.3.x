...
<div class="buttons">
    <form action="<?php echo $continue; ?>" method="POST" id="cardgate_checkout">
        ...
        <?php endforeach; ?>
        <input type="hidden" name="option" value="directdebit" />
        <img src="./image/cgp/directdebit.png" alt="DirectDebit">
    </form>
</div>
<div class="buttons">
...
<script type="text/javascript">
    ...
    function redirectClient() {
        $.ajax({
            type: 'GET',
            url: 'index.php?route=payment/cardgatedirectdebit/confirm',
            beforeSend: function() {
