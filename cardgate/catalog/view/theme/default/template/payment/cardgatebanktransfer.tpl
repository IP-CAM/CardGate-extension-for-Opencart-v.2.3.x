...
<div class="buttons">
    <form action="<?php echo $continue; ?>" method="POST" id="cardgate_checkout">
        ...
        <?php endforeach; ?>
        <input type="hidden" name="option" value="giropay" />
        <img src="./image/cgp/banktransfer.png" alt="Giropay">
    </form>
</div>
<div class="buttons">
...
<script type="text/javascript">
    ...
    function redirectClient() {
        $.ajax({
            type: 'GET',
            url: 'index.php?route=payment/cardgatebanktransfer/confirm',
            beforeSend: function() {
    ...
    $('#cardgate_confirm').bind('click', redirectClient);
</script>