...
<div class="buttons">
    <form action="" method="POST" id="cardgate_checkout">
        <input type="hidden" name="option" value="przelewy24" />
        <img src="./image/payment/cgp/przelewy24.png" alt="Przelewy24">
    </form>
</div>
<div class="buttons">
...
<script type="text/javascript">
    ...
    function redirectClient(response) {
        $.ajax({
            type: 'GET',
            url: 'index.php?route=extension/payment/cardgateprzelewy24/confirm',
            beforeSend: function () {
