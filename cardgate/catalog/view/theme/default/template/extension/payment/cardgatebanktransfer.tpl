...
<div class="buttons">
    <form action="" method="POST" id="cardgate_checkout">
        <input type="hidden" name="option" value="banktransfer" />
        <img src="./image/payment/cgp/banktransfer.png" alt="Giropay">
    </form>
</div>
<div class="buttons">
...
<script type="text/javascript">
    ...
    function redirectClient(response) {
        $.ajax({
            type: 'GET',
            url: 'index.php?route=extension/payment/cardgatebanktransfer/confirm',
            beforeSend: function () {
