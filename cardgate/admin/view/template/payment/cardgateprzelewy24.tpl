    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-cardgateprzelewy24" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cardgateprzelewy24" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_test_mode" id="entry-test-mode" class="form-control">
                                        <?php if ($cardgateprzelewy24_test_mode == "test"): ?>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgateprzelewy24_site_id" value="<?php echo $cardgateprzelewy24_site_id; ?>" placeholder="<?php echo $entry_site_id; ?>" id="entry-site-id" class="form-control" />
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgateprzelewy24_hash_key" value="<?php echo $cardgateprzelewy24_hash_key; ?>" id="entry-hash-key" class="form-control" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="cardgateprzelewy24_gateway_language"><span data-toggle="tooltip" title="<?php echo $text_gateway_language; ?>"><?php echo $entry_gateway_language; ?></span></label>
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_gateway_language" id="cardgateprzelewy24_gateway_language" class="form-control">
                                        <?php
                                        $lang_options = array(
                                        ...
                                        ?>
                                        <option value="<?php echo $key?>"<?php echo ($cardgateprzelewy24_gateway_language == $key) ? ' selected="selected"':''; ?>><?php echo $text; ?></option>
                                        <?php  endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php if (!empty($cardgateprzelewy24_order_description)): ?>
                                    <input type="text" name="cardgateprzelewy24_order_description" value="<?php echo $cardgateprzelewy24_order_description; ?>" id="entry-site-id" class="form-control"/>
                                    <?php else: ?>
                                    <input type="text" name="cardgateprzelewy24_order_description" value="Order %id%" id="entry-site-id" class="form-control"/>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgateprzelewy24_total" value="<?php echo $cardgateprzelewy24_total; ?>" id="entry-total" class="form-control"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_geo_zone_id" id="entry-geo-zone-id" class="form-control">
                                        <option value="0"><?php echo $text_all_zones; ?></option>
                                        <?php foreach ($geo_zones as $geo_zone) { ?>
                                        <?php if ($geo_zone['geo_zone_id'] == $cardgateprzelewy24_geo_zone_id) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_status" id="entry-plugin-status" class="form-control">
                                        <?php if ($cardgateprzelewy24_status): ?>
                        ...
                        <div class="tab-pane" id="tab-status">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_payment_initialized_status" id="entry-payment-initialized-status" class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                                        <?php if ($order_status['order_status_id'] == $cardgateprzelewy24_payment_initialized_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_payment_complete_status" id="entry-payment-complete-status" class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                                        <?php if ($order_status['order_status_id'] == $cardgateprzelewy24_payment_complete_status) { ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                                        <?php } else { ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_payment_failed_status" id="entry-payment-failed-status" class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                                        <?php if ($order_status['order_status_id'] == $cardgateprzelewy24_payment_failed_status) { ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                                        <?php } else { ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="cardgateprzelewy24_payment_fraud_status" id="entry-payment-fraud-status" class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                                        <?php if ($order_status['order_status_id'] == $cardgateprzelewy24_payment_fraud_status) { ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                                        <?php } else { ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgateprzelewy24_sort_order" value="<?php echo $cardgateprzelewy24_sort_order; ?>" id="entry-sort-order" class="form-control"/>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane " id="tab-info">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardgateprzelewy24-control-url" value="<?php echo $text_site_url;?>" class="form-control" /> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo $text_plugin_version; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="cardgateprzelewy24-plugin-version" value="<?php echo $entry_plugin_version;?>" class="form-control" /> 
                                </div>
                            </div>
                            <div class="form-group">
