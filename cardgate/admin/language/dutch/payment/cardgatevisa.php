...
$_['text_success']           = 'Gelukt: U heeft uw Cardgate Visa instellingen gewijzigd!';
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate Visa" title="Cardgate Visa" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_cardgatevisa']      = $_['text_cardgateplus'];
