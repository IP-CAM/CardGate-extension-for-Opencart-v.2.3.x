...
$_['text_success']           = 'Gelukt: U heeft uw Cardgate VPay instellingen gewijzigd!';
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate VPay" title="Cardgate VPay" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_cardgatevpay']      = $_['text_cardgateplus'];
