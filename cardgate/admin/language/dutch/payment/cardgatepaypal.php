...
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate PayPal" title="Cardgate PayPal" style="border: 1px solid #EEEEEE;" /></a>';
