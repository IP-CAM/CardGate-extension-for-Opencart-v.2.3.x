...
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate Direct Debit" title="Cardgate Direct Debit" style="border: 1px solid #EEEEEE;" /></a>';
