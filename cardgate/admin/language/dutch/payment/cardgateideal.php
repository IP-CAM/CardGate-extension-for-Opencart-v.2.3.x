...
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate iDEAL" title="Cardgate iDEAL" style="border: 1px solid #EEEEEE;" /></a>';
