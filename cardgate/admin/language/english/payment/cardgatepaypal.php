...
$_['text_cardgatepaypal']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate PayPal" title="Cardgate PayPal" style="border: 1px solid #EEEEEE;" /></a>';
