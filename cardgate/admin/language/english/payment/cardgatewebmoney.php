...
$_['text_success']           = 'Success: You have modified Cardgate Webmoney account details!';
$_['text_cardgatewebmoney']  = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Webmoney" title="Cardgate Webmoney" style="border: 1px solid #EEEEEE;" /></a>';
