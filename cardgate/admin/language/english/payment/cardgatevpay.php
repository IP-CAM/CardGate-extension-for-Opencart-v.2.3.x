...
$_['text_success']           = 'Success: You have modified Cardgate VPay account details!';
$_['text_cardgatevpay']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate VPay" title="Cardgate VPay" style="border: 1px solid #EEEEEE;" /></a>';
