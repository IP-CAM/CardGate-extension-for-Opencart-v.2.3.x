...
$_['text_success']           = 'Success: You have modified Cardgate American Express account details!';
$_['text_cardgateamex']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate American Express" title="Cardgate American Express" style="border: 1px solid #EEEEEE;" /></a>';
