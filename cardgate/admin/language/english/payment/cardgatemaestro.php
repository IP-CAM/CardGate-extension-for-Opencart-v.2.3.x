...
$_['text_success']           = 'Success: You have modified Cardgate Maestro account details!';
$_['text_cardgatemaestro']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Maestro" title="Cardgate Maestro" style="border: 1px solid #EEEEEE;" /></a>';
