...
$_['text_success']           = 'Success: You have modified Cardgate Mastercard account details!';
$_['text_cardgatemastercard'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Mastercard" title="Cardgate Mastercard" style="border: 1px solid #EEEEEE;" /></a>';
