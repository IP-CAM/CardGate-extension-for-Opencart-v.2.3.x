...
$_['text_cardgategiropay']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Giropay" title="Cardgate Giropay" style="border: 1px solid #EEEEEE;" /></a>';
