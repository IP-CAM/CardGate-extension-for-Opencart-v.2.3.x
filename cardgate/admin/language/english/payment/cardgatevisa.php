...
$_['text_success']           = 'Success: You have modified Cardgate Visa account details!';
$_['text_cardgatevisa']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Visa" title="Cardgate Visa" style="border: 1px solid #EEEEEE;" /></a>';
