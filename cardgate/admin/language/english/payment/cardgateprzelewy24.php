...
$_['text_cardgateprzelewy24'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Przelewy24" title="Cardgate Przelewy24" style="border: 1px solid #EEEEEE;" /></a>';
