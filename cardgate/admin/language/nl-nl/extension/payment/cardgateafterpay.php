...
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate Afterpay" title="Cardgate Afterpay" style="border: 1px solid #EEEEEE;" /></a>';
