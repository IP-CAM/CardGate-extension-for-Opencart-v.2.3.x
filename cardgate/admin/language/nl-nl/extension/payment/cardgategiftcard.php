...
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardate Gift Card" title="Cardgate Gift Card" style="border: 1px solid #EEEEEE;" /></a>';
