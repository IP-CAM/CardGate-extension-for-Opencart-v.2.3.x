...
$_['text_cardgateklarna'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Klarna" title="Cardgate Klarna" style="border: 1px solid #EEEEEE;" /></a>';
