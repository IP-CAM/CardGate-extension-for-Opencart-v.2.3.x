...
$_['text_cardgatepaysafecash']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate PaySafeCash" title="Cardgate PaySafeCash" style="border: 1px solid #EEEEEE;" /></a>';
