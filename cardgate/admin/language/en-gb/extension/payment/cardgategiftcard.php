...
$_['text_success']           = 'Success: You have modified Cardgate Gift Card account details!';
$_['text_cardgategiftcard']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Gift Card" title="Cardgate Gift Card" style="border: 1px solid #EEEEEE;" /></a>';
