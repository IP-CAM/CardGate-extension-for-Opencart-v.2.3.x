...
$_['text_cardgateafterpay'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Afterpay" title="Cardgate Afterpay" style="border: 1px solid #EEEEEE;" /></a>';
