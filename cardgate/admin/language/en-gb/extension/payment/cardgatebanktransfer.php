...
$_['text_cardgatebanktransfer']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Banktransfer" title="Cardgate banktransfer" style="border: 1px solid #EEEEEE;" /></a>';
