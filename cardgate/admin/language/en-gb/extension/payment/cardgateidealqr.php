...
$_['text_cardgateidealqr']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate iDEAL QR" title="Cardgate iDEAL QR" style="border: 1px solid #EEEEEE;" /></a>';
