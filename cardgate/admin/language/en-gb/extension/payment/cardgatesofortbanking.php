...
$_['text_cardgatesofortbanking'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate SofortBanking" title="Cardgate SofortBanking" style="border: 1px solid #EEEEEE;" /></a>';
