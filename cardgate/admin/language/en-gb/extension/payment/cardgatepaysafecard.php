...
$_['text_cardgatepaysafecard']   = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Paysafecard" title="Cardgate Paysafecard" style="border: 1px solid #EEEEEE;" /></a>';
