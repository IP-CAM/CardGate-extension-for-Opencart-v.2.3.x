...
$_['text_cardgatebitcoin'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Bitcoin" title="Cardgate Bitcoin" style="border: 1px solid #EEEEEE;" /></a>';
