...
$_['text_cardgatedirectdebit'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="Cardgate Direct Debit" title="Cardgate Direct Debit" style="border: 1px solid #EEEEEE;" /></a>';
